...
{
  {"command", " Command", PC_COMMAND, "This was the last person to issue a commnd."},
  {"holywalk", " Holywalk", PC_HOLYWALK, "This thing can move wherever it wants whenver it wants."},
  {"holylight", " Holylight", PC_HOLYLIGHT, "This thing can see all."},
  {"holypeace", " Holypeace", PC_HOLYPEACE, "You cannot fight when this is in the same thing as you."},
  {"holyspeed", " Holyspeed", PC_HOLYSPEED, "Does this thing move fast without needing to wait for stuff?"},
  {"wizinvis", " Wizinvis", PC_WIZINVIS, "Is this person invisible to all people below them?"},
  {"wizquiet", " Wizquiet", PC_WIZQUIET, "Does this person block out all channels?"},
  {"zqxsile", " Silenced", PC_SILENCE, "This player cannot talk."},
  {"zqxfroz", " Frozen", PC_FREEZE, "This person cannot do anything."},
  {"zqxdeni", " Denied", PC_DENY, "This person cannot log in at all."},
  {"zqxlog", " Logged", PC_LOG, "This person is being logged."},
  {"zqxpermadeath", " Permadeath", PC_PERMADEATH, "Can only die once."},
  {"unvalidated", " Unvalidated", PC_UNVALIDATED, "This person is not validated and cannot play."},
  {"ascended", " Ascended", PC_ASCENDED, "This person is ascended (super remort)."},
  {"none", "none", 0, "nothing"},
};
const struct flag_data pc2_flags[] =
{
  {"autoloot", " Autoloot", PC2_AUTOLOOT, "This means this player loots automatically."},
  {"autoexit", " Autoexit", PC2_AUTOEXIT, "This player always looks at exits."},
  {"brief", " Brief", PC2_BRIEF, "This player doesn't want to see descs."},
  {"autogold", " Autogold", PC2_AUTOGOLD, "This player loots gold."},
  {"autosac" ," Autosac", PC2_AUTOSAC, "This player auto loots corpses."},
  {"autosplit", " Autosplit", PC2_AUTOSPLIT, "This player splits money gained."},
  {"tackle", " Tackle", PC2_TACKLE, "This player tries to tackle and doesn't care if he is tackled."},
  {"nospam", " Nospam", PC2_NOSPAM, "Does not see spammy messages."},
  {"mapping", " Mapping" ,PC2_MAPPING, "The player sees overhead map."},
  {"assist", " Assist", PC2_ASSIST, "This player assists groupies in combat."},
  {"autoscan", " Autoscan", PC2_AUTOSCAN, "This player automatically scans opp align people."},
  {"ansi", " Ansi", PC2_ANSI, "This player sees ansi colors."},
...
const struct _forge_data forge_data[] =
{
  ...
  {"anvil", ITEM_WEAR_WIELD, VAL_TOOL, STAT_MAX, 0, TOOL_ANVIL, 150, 10000},
  {"hammer", ITEM_WEAR_WIELD, VAL_TOOL, STAT_MAX, 0, TOOL_HAMMER, 40, 5000},
  {"helmet", ITEM_WEAR_HEAD, VAL_ARMOR, STAT_WIS, 0, 0, 40, 3000},
  {"mask", ITEM_WEAR_FACE, VAL_ARMOR, STAT_INT, 0, 0, 20, 2500},
  {"plate", ITEM_WEAR_BODY, VAL_ARMOR, STAT_STR, 0, 0, 70, 3500},
  {"vambraces", ITEM_WEAR_ARMS, VAL_ARMOR, STAT_STR, 0, 0, 50, 4000},
  {"gauntlets", ITEM_WEAR_HANDS, VAL_ARMOR, STAT_DEX, 0, 0, 20, 3500},
  {"shield", ITEM_WEAR_SHIELD, VAL_ARMOR, STAT_DEX, 0, 0, 50, 3000},
  {"sword", ITEM_WEAR_WIELD, VAL_WEAPON, STAT_MAX, 2, WPN_DAM_SLASH, 60, 3000},
  {"mace", ITEM_WEAR_WIELD, VAL_WEAPON, STAT_WIS, 2, WPN_DAM_CONCUSSION, 55, 4000},
  {"dagger", ITEM_WEAR_WIELD, VAL_WEAPON, STAT_DEX, 2, WPN_DAM_PIERCE, 25, 6000},
  {"belt", ITEM_WEAR_WAIST, VAL_ARMOR, STAT_STR, 0, 0, 20, 6000},
  {"greaves", ITEM_WEAR_LEGS, VAL_ARMOR, STAT_MAX, 0, 0, 50, 4000},
  {"boots", ITEM_WEAR_FEET, VAL_ARMOR, STAT_MAX, 0, 0, 40, 5000},
  {"", 0, 0, 0, 0, 0, 0, 0},
};
