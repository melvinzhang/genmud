/* Copyright 2001-2002 John R. Arras See LICENSE.TXT for the license info. */
#include <time.h>
#include <sys/time.h>
...
#define MOBGEN_LOAD_AREA_VNUM    101000 /* Area where the mobgens
...
#define DEFAULT_PROMPT    "@ed@@bl@@dl@$C@hc@/@hm@$7hp $A@vc@/@vm@$7mv $D@mc@/@mm@$7m @tk@@oc@> "

/* This is the name of the game used for logins and who list and stuff. */
#define game_name_string "\x1b[1;31mBattle for Destiny\x1b[0;37m"
...
#define SERVER_RUNNING             0x00001000  /* Is someone running? */
...
#define VAL_MAX              48 /* Total number of values. */
...
#define FLAG_AFF_DAM           36  
#define FLAG_AFF_HIT           37
#define FLAG_AFF_MV            38
#define FLAG_AFF_HP            39
#define FLAG_AFF_SPELL_ATTACK  40
#define FLAG_AFF_SPELL_HEAL    41
#define FLAG_AFF_SPELL_RESIST  42
#define FLAG_AFF_THIEF_ATTACK  43
#define FLAG_AFF_DEFENSE       44 /* Helps with dodge/parry/shieldblock */
#define FLAG_AFF_KICKDAM       45
#define FLAG_AFF_ARMOR         46
#define FLAG_AFF_DAM_RESIST    47 /* Removes pcts of physical damage */
#define FLAG_AFF_GF_ATTACK     48 /* +groundfight attack. */
#define FLAG_AFF_GF_DEFENSE    49 /* +groundfight defense. */
  /* Start of flags that let you change the elemental power for spells */
#define FLAG_ELEM_POWER_START  50 
  
  /* We should never actually access any of these variables. */

#define FLAG_ELEM_POWER_AIR    50
#define FLAG_ELEM_POWER_EARTH  51
#define FLAG_ELEM_POWER_FIRE   52
#define FLAG_ELEM_POWER_WATER  53
#define FLAG_ELEM_POWER_SPIRIT 54

  /* Start of flags that raise or lower your level in certain mana colors. */
#define FLAG_ELEM_LEVEL_START  55

 /* We should never actually access any of these variables. */
#define FLAG_ELEM_LEVEL_AIR    55
#define FLAG_ELEM_LEVEL_EARTH  56
#define FLAG_ELEM_LEVEL_FIRE   57
#define FLAG_ELEM_LEVEL_WATER  58
#define FLAG_ELEM_LEVEL_SPIRIT 59
...
#define PREREQ_PCT          50 /* The pct you need to have spells pracced
...
struct thing_data
{
  ...
  NEED *needs;                      /* Society members have needs (for objs). */
...
/* The ranks of power that things have. */
extern const int aff_power_ranks[AFF_MAX-AFF_START];
...
char *name (THING *viewer, THING *victim); /* This is the name viewer sees
...
void do_gather (THING *, char *); /* Herbs */
...
#define RUNNING            (IS_SET (server_flags, SERVER_RUNNING))
